...
import ukic.ante.dineeasy.databinding.FragmentTableSelectionLariBinding
import ukic.ante.dineeasy.model.Reservation

class LariTableSelectionFragment:Fragment() {
    private lateinit var binding: FragmentTableSelectionLariBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTableSelectionLariBinding.inflate(layoutInflater)

        reservation = LariTableSelectionFragmentArgs.fromBundle(requireArguments()).reservation
        setUpTables()
    ...
    private fun reserveTable(table: String) {
        ...
        val action = LariTableSelectionFragmentDirections.actionLariTableSelectionFragmentToOrderConfirmationFragment(reservation)
