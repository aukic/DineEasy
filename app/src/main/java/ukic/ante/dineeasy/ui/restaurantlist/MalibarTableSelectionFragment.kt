...
import ukic.ante.dineeasy.databinding.FragmentTableSelectionMalibarBinding
import ukic.ante.dineeasy.model.Reservation

class MalibarTableSelectionFragment:Fragment() {
    private lateinit var binding: FragmentTableSelectionMalibarBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTableSelectionMalibarBinding.inflate(layoutInflater)

        reservation = MalibarTableSelectionFragmentArgs.fromBundle(requireArguments()).reservation
        setUpTables()
    ...
    private fun reserveTable(table: String) {
        ...
        val action = MalibarTableSelectionFragmentDirections.actionMalibaTableSelectionFragmentToOrderConfirmationFragment(reservation)
